    ...
    <div>
      <div className='w-full flex justify-center items-center  h-mainBox'>
        <div className='bg-image w-full sm:w-1/2 md:w-9/12 lg:w-4/6 lg:h-2/3 mx-3 md:mx-5 lg:mx-0 shadow-md flex flex-col md:flex-row items-center rounded z-10 overflow-hidden bg-center bg-cover bg-blue-600'>
          ...
          <div className='w-full h-full md:w-1/2 flex flex-col items-center bg-white py-12 md: px-4'>
            <h3 className='mb-5 mt-3 font-bold text-4xl flex items-center text-blue-400'>피드백 남기기</h3>
            <form action='#' className='px-3 flex h-full flex-col justify-around items-center w-full gap-2'>
              <textarea
                onChange={onChange}
                placeholder='방구석 화방을 이용하시면서 느꼈던 점들을 공유해주세요:) &#13;&#10;무엇이든 좋습니다!'
                className='px-4 pt-2 w-10/12 flex-grow rounded border border-gray-300 shadow-sm text-base placeholder-gray-500 placeholder-opacity-50 focus:outline-none focus:border-blue-500'
                maxLength={1000}
              />
